        ...
        for bill in bills:
            ...
            for biaya_service_line in biaya_service_lines:
                ...
                data = [
                    ...
                    biaya_service_line.notes or '',
                    biaya_service_line.invoice_id.reference or '',
                    biaya_service_line.quantity,
                    biaya_service_line.uom_id.name,
                    biaya_service_line.price_unit,
                    bill.currency_id.name,
                    rate_kurs_line,
                    #GRIR
                    '',
            ...
            for jasa_lain_line in jasa_lain_lines:
                ...
                data = [
                    ...
                    jasa_lain_line.notes or '',
                    jasa_lain_line.invoice_id.reference or '',
                    jasa_lain_line.quantity,
                    jasa_lain_line.uom_id.name,
                    jasa_lain_line.price_unit,
                    bill.currency_id.name,
                    rate_kurs_line,
                    #GRIR
                    '',
            ...
            for min_order_line in min_order_lines:
                ...
                data = [
                    ...
                    min_order_line.notes or '',
                    min_order_line.invoice_id.reference or '',
                    min_order_line.quantity,
                    min_order_line.uom_id.name,
                    min_order_line.price_unit,
                    bill.currency_id.name,
                    rate_kurs_line,
                    #GRIR
                    '',
            ...
            for bi_local_line in bi_local_lines:
                ...
                data = [
                    ...
                    bi_local_line.notes or '',
                    bi_local_line.invoice_id.reference or '',
                    bi_local_line.quantity,
                    bi_local_line.uom_id.name,
                    bi_local_line.price_unit,
                    bill.currency_id.name,
                    rate_kurs_line,
                    #GRIR
                    '',
            ...
            for bi_import_line in bi_import_lines:
                ...
                data = [
                    ...
                    bi_import_line.notes or '',
                    bi_import_line.invoice_id.reference or '',
                    bi_import_line.quantity,
                    bi_import_line.uom_id.name,
                    bi_import_line.price_unit,
                    bill.currency_id.name,
                    rate_kurs_line,
                    #GRIR
                    '',
            ...
            for pph22_line in pph22_lines:
                ...
                data = [
                    ...
                    pph22_line.invoice_id.reference or '',
                    pph22_line.quantity,
                    pph22_line.uom_id.name,
                    pph22_line.price_unit,
                    bill.currency_id.name,
                    rate_kurs_line,
                    #GRIR
                    '',
            ...
            for pph23_line in pph23_lines:
                ...
                data = [
                    ...
                    pph23_line.invoice_id.reference or '',
                    pph23_line.quantity,
                    pph23_line.uom_id.name,
                    pph23_line.price_unit,
                    bill.currency_id.name,
                    rate_kurs_line,
                    #GRIR
                    '',
            ...
            for pph23s_line in pph23s_lines:
                ...
                data = [
                    ...
                    pph23s_line.notes or '',
                    pph23s_line.invoice_id.reference or '',
                    pph23s_line.quantity,
                    pph23s_line.uom_id.name,
                    pph23s_line.price_unit,
                    bill.currency_id.name,
                    rate_kurs_line,
                    #GRIR
                    '',
            ...
            for retur_line in retur_lines:
                ...
                data = [
                    ...
                    retur_line.invoice_id.reference or '',
                    retur_line.quantity,
                    retur_line.uom_id.name,
                    retur_line.price_unit,
                    bill.currency_id.name,
                    rate_kurs_line,
                    #GRIR
                    '',
