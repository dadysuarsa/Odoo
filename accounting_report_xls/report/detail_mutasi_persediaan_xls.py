...
class detail_mutasi_persediaan_xls(report_xls):
...
detail_mutasi_persediaan_xls('report.detail.mutasi.persediaan.xls', 'stock.move', 'addons/accounting_report_xls/report/report_excel.mako', parser=ReportStatus, header=False)
